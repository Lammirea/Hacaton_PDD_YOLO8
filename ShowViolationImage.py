...
def isViolationImage(SOURCE_IMAGE_PATH):
   # load a pre-trained or custom-trained model
    ...
    resultsSegmentLines = modelSegmentLines.predict(SOURCE_IMAGE_PATH,conf=0.2)
    resultsSegmentCross = modelSegmentCross.predict(SOURCE_IMAGE_PATH,conf=0.2)
...
def findViolation(resultsDetect,resultsSegLine,resultsSegCross ):
    ...
    selected_classes = ["crosswalk","humans","red_pedestrian_light","green_light_traffic"]
...
if __name__=="__main__":
    #isViolationImage('http://92.53.97.223:8081/files/1e5d976d-8017-4942-9919-a648f99dc6aa')
